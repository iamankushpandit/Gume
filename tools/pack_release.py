...
ENV_BLURBS = {
    ...
    "audiodiag": "DAC audio bring-up probe: sine wave, frequency sweep, the "
                 "full cue vocabulary and the boot phrase, built alone so the "
                 "app's frame budget and watchdog cannot interfere.",
