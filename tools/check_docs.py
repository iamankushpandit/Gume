...
def check_site(problems):
    ...
    # CI must take its build list from the generator. If it ever goes back to a
    # hardcoded one, every environment has to be named in it -- otherwise a
    # board reaches the page with no binaries behind it.
