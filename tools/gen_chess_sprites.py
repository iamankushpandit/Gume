...
# The licence notice these generators emit into what they write. One
# definition, in the checker that looks for it -- a second copy of a
# licence header is a copy that falls behind. See tools/check_licenses.py.
...
def main():
    ...
    header = header_for('.h') + '''#pragma once
