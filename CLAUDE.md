...
Flash is global and nearly the binding constraint (2,340,581 / 3,145,728 bytes,
**74.4%**; NimBLE plus the BT controller account for ~192 KB of that). RAM sits
at 72,028 / 327,680 (22.0%) -- higher than it was, deliberately: RowList traded
