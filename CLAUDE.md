...
Flash is global and nearly the binding constraint (2,329,205 / 3,145,728 bytes,
**74.0%**; NimBLE plus the BT controller account for ~192 KB of that). RAM sits
at 72,004 / 327,680 (22.0%) -- higher than it was, deliberately: RowList traded
