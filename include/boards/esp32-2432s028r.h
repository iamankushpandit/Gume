...
/* No codec; DAC output on GPIO26 (ESP32 DAC2). Same reasoning as the touch
...
/* irqUsable         */ true,
    ...
    /* Audio amplifier input on GPIO26 (ESP32 DAC2). No amplifier enable wired.
     * maxVolume 75 -- same reasoning as the 2.8-inch board. */
    AudioProfile{
        /* speakerPin          */ 26,
        /* codecI2cAddress     */ 0,
        /* i2sMclk             */ PIN_NONE,
