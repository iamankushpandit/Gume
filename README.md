...
[![Flash](https://img.shields.io/badge/flash-77.2%25%20of%203%20MB-yellow)](#build-and-flash)
...
|---|---|
| Games | 35 |
| Flash | 2,427,753 / 3,145,728 bytes (**77.2%**) |
| RAM | 76,220 / 327,680 bytes (**23.3%**) |
...
| **Cursive** | Joined-up handwriting, traced with a finger: capitals, lowercase, and ten easy three-letter words. Dots to follow, one letter at a time, with the stroke order a hand actually uses | Cursive is a different skill from printing, not a decoration on it — most of these letters are one unbroken movement, and words are where joining up starts to mean something | 5+ |
...
In development: **5.9.0-SNAPSHOT** — the last release was **5.8.0**. See
