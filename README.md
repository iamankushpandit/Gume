...
[![Version](https://img.shields.io/badge/version-5.2.0--SNAPSHOT-9a6700)](CHANGELOG.md)
...
`.github/workflows/pages.yml`, which builds all four PlatformIO environments on
...
In development: **5.2.0-SNAPSHOT** — the last release was **5.1.0**. See
