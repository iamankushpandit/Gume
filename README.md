...
[![Version](https://img.shields.io/badge/version-5.3.0--SNAPSHOT-9a6700)](CHANGELOG.md)
...
[![Flash](https://img.shields.io/badge/flash-75.8%25%20of%203%20MB-yellow)](#build-and-flash)
...
|---|---|
| Games | 31 |
| Flash | 2,383,373 / 3,145,728 bytes (**75.8%**) |
| RAM | 73,644 / 327,680 bytes (**22.5%**) |
...
In development: **5.3.0-SNAPSHOT** — the last release was **5.2.0**. See
