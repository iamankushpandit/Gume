...
/*
 * Guess the US state from its outline.
 *
 * Shows a state map silhouette from the map-n-flag library and asks which
 ...
 */
class StateMapGame : public AppGame {
public:
...
private:
    ...
    Rect imageRect(const Ui::Frame& f) const;
