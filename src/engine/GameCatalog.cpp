...
const GameCatalogEntry GAME_CATALOG[GAME_CATALOG_COUNT] = {
    ...
    { "cinnamon",      "Cinnamon",       "repeat colors",     "Cinnamon",       "Repeat the colour sequence."     },
    { "microku",     "Microku",      "2x2 to 6x6",        "Microku",      "2x2 up to 6x6 grids."            },
    ...
    { "trace",      "Trace",       "ABC abc 123",       "Trace",       "Trace big and small letters."    },
