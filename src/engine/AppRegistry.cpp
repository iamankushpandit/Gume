...
const AppDefinition APP_REGISTRY[APP_REGISTRY_COUNT] = {
    ...
    metadataCatalogApp(memoryAppMetadata(), memory, true),
    metadataCatalogApp(mathAppMetadata(), math, true),
    metadataCatalogApp(multiplicationAppMetadata(), multiplication, true),
    metadataCatalogApp(timeGameAppMetadata(), time, true),
    metadataCatalogApp(whackAMoleAppMetadata(), whackAMole, true),
    metadataCatalogApp(cinnamonAppMetadata(), cinnamon, true),
    ...
    metadataCatalogApp(colorMixAppMetadata(), colorMix, true),
    ...
    systemApp("wifi", "Wi-Fi", "network & time", LauncherIcon::WiFi, wifi,
              APP_CAP_DEVICE_STATUS | APP_CAP_NETWORK, true),
