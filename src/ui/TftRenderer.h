...
public:
     ...
     * driver instance is shared with ScaledRenderer, which sets a bigger
     * size for playable games. Without resetting it here, system-app text
     * would inherit whatever a game left behind. */
